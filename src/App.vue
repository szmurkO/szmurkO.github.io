...
<template>
    <div>
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://lh3.googleusercontent.com/-nXwXoNRhxMs/AAAAAAAAAAI/AAAAAAAAAAA/ALKGfkll-QWoIHGiHRiO-l8gzWEDUj9HKw/photo.jpg?sz=46"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">szmurk0</div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            ...
            <ul>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Jebać FSM!</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">To wszystko wina FSMu!</li>
            </ul>
        </div>
    </div>
